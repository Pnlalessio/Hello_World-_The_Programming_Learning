...
-- User_Feedback [rel16]
alter table "APP"."FEEDBACK"  add column  "USER_OID"  integer;
alter table "APP"."FEEDBACK"   add constraint FK_FEEDBACK_USER foreign key ("USER_OID") references "APP"."USER" ("OID");
...
-- Course.avgrating [ent2#att26]
create view "APP"."COURSE_AVGRATING_VIEW" as
select AL1."OID" as "OID", avg(AL2."RATING") as "DER_ATTR"
from  "APP"."COURSE" AL1 
               left outer join "APP"."FEEDBACK" AL2 on AL1."OID"=AL2."COURSE_OID"
group by AL1."OID";


-- Course.#followers [ent2#att27]
create view "APP"."COURSE_FOLLOWERS_VIEW" as
select AL1."OID" as "OID", count(distinct AL2."OID") as "DER_ATTR"
from  "APP"."COURSE" AL1 
               left outer join "APP"."COURSE_FOLLOWED" AL2 on AL1."OID"=AL2."COURSE_OID"
group by AL1."OID";
