...
alter table "APP"."SUPPORT"   add constraint FK_SUPPORT_USER_2 foreign key ("USER_OID") references "APP"."USER" ("OID");
...
alter table "APP"."SUPPORT"  add column  "COURSE_OID"  integer;
alter table "APP"."SUPPORT"   add constraint FK_SUPPORT_COURSE foreign key ("COURSE_OID") references "APP"."COURSE" ("OID");
...
-- Forum.Name [ent12#att39]
-- Unable to compute the view for the derived element 'Name [ent12#att39]'
-- com.webratio.ide.derivation.DerivationException: Unable to generate view for attribute: Name [ent12#att39] (Self.rel11#role22(as Var1).ent2#att7 || ' ' || Forum)
...
-- Caused by: com.webratio.ide.derivation.internal.parser.ParseException: Alias Forum is undefined.
-- 	at com.webratio.ide.derivation.internal.parser.OQLParser.PathExpression(OQLParser.java:234)
-- 	at com.webratio.ide.derivation.internal.parser.OQLParser.AttributeExpression(OQLParser.java:346)
-- 	at com.webratio.ide.derivation.internal.parser.OQLParser.AttributeValue(OQLParser.java:554)
